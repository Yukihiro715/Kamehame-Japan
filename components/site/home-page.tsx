...
const COPY = {
  ...
  fr: {
    ...
    heroBubble: "Ce n'est pas une démonstration —\ncette place est la vôtre.", heroSpeaker: "— votre maître",
    ...
    kicker: ["Explorer par envie", "8 portes sur le Japon"], catTitle: "Suivez votre curiosité.",
  ...
  "zh-tw": {
    ...
    kicker: ["依興趣探索", "通往日本的 8 扇門"], catTitle: "跟著好奇心走。",
