...
export interface Review {
  ...
  source: "google" | "bokun" | "direct" | "venue" | "trial" | "sample";
...
const REVIEWS: Review[] = [
  ...
  // source "trial": guests of the calligraphy teacher's trial (monitor) classes,
  // supplied by the partner. Shown with that label, no verified badge, and left
  // out of the rating declared in structured data (see ownReviewsFor).
  {
    id: "t1", experience: "kanji-name-calligraphy", rating: 5, author: "Emily R.", country: "US", source: "trial",
  ...
  {
    id: "t2", experience: "kanji-name-calligraphy", rating: 5, author: "Lucas M.", country: "FR", source: "trial",
  ...
  {
    id: "t3", experience: "kanji-name-calligraphy", rating: 5, author: "Olivia B.", country: "AU", source: "trial",
  ...
  {
    id: "t4", experience: "kanji-name-calligraphy", rating: 4, author: "Daniel W.", country: "GB", source: "trial",
  ...
  {
    id: "t5", experience: "kanji-name-calligraphy", rating: 5, author: "Sophie L.", country: "CA", source: "trial",
...
export const ownReviewsFor = (experience: string): Review[] => reviewsFor(experience).filter((r) => r.source !== "venue" && r.source !== "trial");
