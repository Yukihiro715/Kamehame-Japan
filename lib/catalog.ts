...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "0:00", title: "Your private room", body: "You are seated on tatami; the first courses and drinks arrive.", img: "/images/geiko-room-upstairs.jpg" },
      { time: "0:15", title: "Your geiko or maiko arrives", body: "She joins the table straight from the okiya and stays about 1 hour 45 minutes. Conversation over dinner, with your interpreter carrying both sides.", img: "/images/geiko-conversation.jpg" },
      { time: "1:00", title: "The dance", body: "One dance before the gold screen, to recorded music unless you add a shamisen player. Cameras are welcome.", img: "/images/geiko-dance.jpg" },
      { time: "1:15", title: "Ozashiki games", body: "Konpira Funefune, a rhythm game, and Tora-tora, rock-paper-scissors played with the whole body.", img: "/images/geiko-game-toratora.jpg" },
      { time: "1:50", title: "Photographs", body: "Commemorative photos with your host.", img: "/images/geiko-photo-together.jpg" },
