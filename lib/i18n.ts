...
const strings = {
  en: {
    ...
    form: {
      ...
      guests: (n: number) => (n === 1 ? "1 guest" : `${n} guests`), guestsMore: (n: number) => `${n} or more`, preferredDate: "Preferred date", altDate: "Alternative date (optional)", partyN: "Number of guests", messageXp: "Anything we should check with the venue? (optional)", messageXpHint: "Dietary needs, mobility, a birthday, a preferred start time…",
  ...
  es: {
    ...
    form: {
      ...
      guests: (n: number) => (n === 1 ? "1 persona" : `${n} personas`), guestsMore: (n: number) => `${n} o más`, preferredDate: "Fecha preferida", altDate: "Fecha alternativa (opcional)", partyN: "Número de personas", messageXp: "¿Algo que consultar con el lugar? (opcional)", messageXpHint: "Alergias, movilidad, un cumpleaños, hora de inicio preferida…",
  ...
  ja: {
    ...
    form: {
      ...
      guests: (n: number) => `${n}名`, guestsMore: (n: number) => `${n}名以上`, preferredDate: "第1希望日", altDate: "第2希望日(任意)", partyN: "ご人数", messageXp: "受け入れ先に確認しておくこと(任意)", messageXpHint: "食事制限、移動のご事情、お祝い、希望の開始時刻など",
  ...
  fr: {
    ...
    form: {
      ...
      guests: (n: number) => (n === 1 ? "1 personne" : `${n} personnes`), guestsMore: (n: number) => `${n} ou plus`, preferredDate: "Date souhaitée", altDate: "Autre date possible (facultatif)", partyN: "Nombre de personnes", messageXp: "Quelque chose à vérifier auprès du lieu ? (facultatif)", messageXpHint: "Régimes, mobilité, anniversaire, heure de début souhaitée…",
  ...
  "zh-tw": {
    ...
    form: {
      ...
      guests: (n: number) => `${n} 位`, guestsMore: (n: number) => `${n} 位以上`, preferredDate: "首選日期", altDate: "備選日期（可不填）", partyN: "人數", messageXp: "需要向店家確認的事項（可不填）", messageXpHint: "飲食限制、行動需求、慶祝活動、希望的開始時間等",
