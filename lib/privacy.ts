    ...
    sections: [
      {
        ...
        body: [
          "KAMEHAME JAPAN is operated by Prosent Inc. (Japan), which decides how the information described here is used. Write to hello@kamehame-japan.com with any question about this page or about your own data.",
        ],
      },
      {
    ...
    sections: [
      {
        heading: "運営者",
        body: [
          "KAMEHAME JAPANはProsent Inc.(日本)が運営し、ここに記載する情報の取り扱いを決定しています。本ページやお客様ご自身の情報についてのご質問は hello@kamehame-japan.com までご連絡ください。",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          "KAMEHAME JAPAN es operado por Prosent Inc. (Japón), que decide cómo se utiliza la información descrita aquí. Escriba a hello@kamehame-japan.com con cualquier duda sobre esta página o sobre sus datos.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          "KAMEHAME JAPAN est exploité par Prosent Inc. (Japon), qui décide de l'usage des informations décrites ici. Écrivez à hello@kamehame-japan.com pour toute question sur cette page ou sur vos propres données.",
        ],
      },
      {
    ...
    sections: [
      {
        heading: "營運者",
        body: [
          "KAMEHAME JAPAN 由 Prosent Inc.（日本）營運，並決定本頁所述資料的使用方式。對本頁或您個人資料有任何疑問，請來信 hello@kamehame-japan.com。",
        ],
      },
      {
        heading: "當您送出詢問時",
