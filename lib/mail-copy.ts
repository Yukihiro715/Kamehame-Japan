...
interface AckCopy {
  ...
  notYet: string;
  echoH: string;
  labels: { dates: string; party: string; company: string; country: string; message: string; plan: string; extras: string; estimate: string; interpreter: string };
  addMore: string;
  sign: string;
}
...
const COPY: Record<Lang, AckCopy> = {
  en: {
    ...
    labels: { dates: "Dates", party: "Guests", company: "Company", country: "Country", message: "Notes", plan: "Plan", extras: "Extras", estimate: "Estimate", interpreter: "Interpreter" },
  ...
  ja: {
    ...
    echoH: "お送りいただいた内容:",
    labels: { dates: "日程", party: "人数", company: "会社名", country: "国", message: "備考", plan: "プラン", extras: "オプション", estimate: "概算", interpreter: "通訳" },
  ...
  es: {
    ...
    labels: { dates: "Fechas", party: "Personas", company: "Empresa", country: "País", message: "Notas", plan: "Plan", extras: "Extras", estimate: "Estimación", interpreter: "Intérprete" },
  ...
  fr: {
    ...
    labels: { dates: "Dates", party: "Personnes", company: "Société", country: "Pays", message: "Remarques", plan: "Formule", extras: "Options", estimate: "Estimation", interpreter: "Interprète" },
  ...
  "zh-tw": {
    ...
    echoH: "您送出的內容：",
    labels: { dates: "日期", party: "人數", company: "公司", country: "國家", message: "備註", plan: "方案", extras: "加購", estimate: "預估", interpreter: "口譯" },
